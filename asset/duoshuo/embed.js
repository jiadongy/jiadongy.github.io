!function(e, t, s) {
    ...
    function n(e) {
        ...
        "none" != e && o.injectStylesheet(S.STATIC_LOCAL + "/styles/embed" + (e ? "." + e + ".css?" + M[e] : "." + short_name) + ".css")
    }
    var o = {}
    ...
    !e.DUOSHUO) {
        ...
        S.require = function() {
            function t(e) {
                ...
                return S.STATIC_LOCAL + "/libs/" + e + ".js" + t//todo
            }
            var s = {
        ...
        S.STATIC_URL = g + "//static.duoshuo.com",//todo
        S.STATIC_LOCAL = "./asset/duoshuo",//todo new add
